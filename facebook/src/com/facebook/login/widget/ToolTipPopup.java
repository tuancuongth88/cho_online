...
public class ToolTipPopup {
	...
	public static enum Style {
		/**
		 * The tool tip will be shown with a blue style; including a blue
		 * background and blue arrows.
		 */
		BLUE,

		/**
		 * The tool tip will be shown with a black style; including a black
		 * background and black arrows.
		 */
		BLACK
	}
	 ...
	 * @param anchor
	 *            The view to anchor this tool tip to.
	 */
	...
	public void show() {
		if (mAnchorViewRef.get() != null) {
			...
			registerObserver();
			mPopupContent.measure(View.MeasureSpec.makeMeasureSpec(decorWidth, View.MeasureSpec.AT_MOST),
					View.MeasureSpec.makeMeasureSpec(decorHeight, View.MeasureSpec.AT_MOST));
			mPopupWindow = new PopupWindow(mPopupContent, mPopupContent.getMeasuredWidth(),
	...
	/**
	 * Set the time (in milliseconds) the tool tip will be displayed. Any number
	 * less than or equal to 0 will cause the tool tip to be displayed
	 * indefinitely
	 * 
	 * @param displayTime
	 *            The amount of time (in milliseconds) to display the tool tip
	 */
